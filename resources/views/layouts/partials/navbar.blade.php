        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="d-flex flex-column flex-lg-row w-100 align-items-lg-center justify-content-between">
                <ul class="navbar-nav mx-lg-auto order-2 order-lg-1 my-3 my-lg-0 gap-lg-2">
                    <li class="nav-item"><a class="nav-link {{ Route::is('atlet*') ? 'active fw-semibold' : '' }} " href="{{ route('atlet') }}">Atlet</a></li>
                    <li class="nav-item"><a class="nav-link {{ Route::is('club*') ? 'active fw-semibold' : '' }}" href="{{ route('club') }}">Klub</a></li>
