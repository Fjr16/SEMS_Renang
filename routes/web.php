...
Route::middleware(['auth'])->group(function(){
    ...
    Route::prefix('/master')->group(function(){
        ...
        Route::prefix('/atlet')->group(function(){
            ...
            // import
            Route::get('/template', [AthleteController::class, 'downloadTemplate'])->name('atlet.template')->middleware('permission:Master Setting.Atlet-Tambah|Master Setting.Atlet-Ubah');
            Route::post('/import', [AthleteController::class, 'import'])->name('atlet.import')->middleware('permission:Master Setting.Atlet-Tambah|Master Setting.Atlet-Ubah');
    ...
    Route::prefix('/export')->group(function(){
        ...
        Route::post('/best/club', [ExportController::class, 'bestClub'])->name('export.best.club');
        Route::post('/best/swimmer', [ExportController::class, 'bestSwimmer'])->name('export.best.swimmer');
    });
